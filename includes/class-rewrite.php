...
class NT_Rewrite {
    ...
    private static function render_translated_content( $content ) {
        ...
        // v2.6.7: Last-line defense against old saved placeholder artifacts such as NTP0/NTP1/NTP2.
        // Clean before block rendering so stray markers above images never reach the theme.
        if ( class_exists( 'NT_DB' ) ) {
            $content = NT_DB::clean_symbolic_tokens( $content );
        }
